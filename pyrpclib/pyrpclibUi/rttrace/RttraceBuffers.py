...
class RttraceBuffers(QtGui.QTreeWidget):
    ...
    BUFFERS = { 'RING_TX': RttraceBuffer.RttraceBufferRingTx,
                'RING_RX': RttraceBuffer.RttraceBufferRingRx,
                'FPGA_CAP_THREAD': RttraceBuffer.RttraceBufferFpgaCap,
                'FPGA_TX' : RttraceBuffer.RttraceBufferFpgaTx,
                "default": RttraceBuffer.RttraceBuffer }
